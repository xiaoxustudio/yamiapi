<!--
 * @Author: xuranXYS
 * @LastEditTime: 2023-10-06 18:27:55
 * @GitHub: www.github.com/xiaoxustudio
 * @WebSite: www.xiaoxustudio.top
 * @Description: By xuranXYS
-->
# filter.js文件  
这是一个渲染部分的代码（原谅我不会webgl，所以我会跳过涉及到它的代码）
```js
...
```
这个是创建了一个渲染器`Tinter`对象  
可以看到有一个全局变量`tint`这个我之前研究过，作用存储的是rgba颜色  
所以`update`方法就是调用全局场景对象来设置色调
